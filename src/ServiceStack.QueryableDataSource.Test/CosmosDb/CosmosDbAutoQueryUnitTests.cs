...
namespace ServiceStack.QueryableDataSource.CosmosDb.Test
{
    ...
    [TestFixture]
    public class CosmosDbAutoQueryUnitTests
    {
        ...
        [Test]
        public void Can_GET_document_from_CosmosDb_with_Name_AutoQueryDataSource()
        {
        ...
        [Test]
        public void Can_GET_document_from_CosmosDb_MIN_AutoQueryDataSource()
        {
        ...
        [Test]
        public void Can_GET_document_from_CosmosDb_FIRST_AutoQueryDataSource()
        {
